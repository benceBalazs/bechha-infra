<script lang="ts">
	...
	let selectedSegmentItem: SearchResult = {
		...
		description:
			'the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor he quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor he quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor he quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor the quiet neighbor - the quiet neighbor',
		tokens: [
			'quiet',
			'neighbor',
			'quiet',
		...
		<div class="modal-box w-11/12 max-w-6xl grid grid-cols-3 gap-4">
			<div class="w-full col-span-1 flex flex-col gap-4">
				...
				<p class="overflow-y-auto max-h-24 shadow-inner">
					Description: {selectedSegmentItem.description}
				</p>
				<p class="text-sm">
					Time: | <em>{selectedSegmentItem.starting_time}</em> -
					<em>{selectedSegmentItem.ending_time}</em> | (in ms)
				</p>
				<p class="text-sm">
					Frames: | <em>{selectedSegmentItem.starting_frame}</em> -
					<em>{selectedSegmentItem.ending_frame}</em> |
				</p>
